...
import 'package:flutter_chat_app/auth/edit_user_info.dart';
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
              ...
              onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (_) => EditUserInfo(name: name , userImg: image,uid: uid,)));
              },
            )
          ],
        ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: IconButton(
                ...
                onPressed: (){
                  _postRec.reference.delete().then((val){
